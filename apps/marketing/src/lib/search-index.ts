...
const STATIC_INDEX: SearchEntry[] = [
  ...
  {
    path: '/nata-online-coaching/comparison',
    title: 'NATA Online Coaching Comparison: Neram vs BRDS vs SILICA',
    description: 'Honest side-by-side comparison of the top 3 NATA online coaching institutes in India.',
    keywords: ['nata coaching comparison', 'neram vs brds', 'neram vs silica', 'brds vs silica', 'best nata coaching institute', 'nata coaching fees comparison'],
    category: 'coaching',
  },
  {
    path: '/nata-cutoff-trends-2015-2025',
    title: 'NATA Cutoff Trends 2015 to 2025',
    description: '10-year NATA cutoff and qualifying score analysis for top architecture colleges in India.',
    keywords: ['nata cutoff', 'nata cutoff trends', 'nata qualifying score', 'nata cutoff history', 'nata score for spa delhi', 'nata score for nit trichy'],
    category: 'tool',
  },
  {
    path: '/nata-coaching/chennai',
    title: 'NATA Online Coaching in Chennai',
    description: 'NATA online coaching for Chennai students with NIT/IIT alumni faculty.',
    keywords: ['nata online coaching chennai', 'nata coaching chennai online', 'nata classes chennai', 'nata coaching anna nagar', 'nata coaching adyar', 'nata coaching tambaram'],
    category: 'coaching',
  },
  {
    path: '/nata-coaching/coimbatore',
    title: 'NATA Online Coaching in Coimbatore',
    description: 'NATA online coaching for Coimbatore students with NIT/IIT alumni faculty.',
    keywords: ['nata online coaching coimbatore', 'nata coaching coimbatore online', 'nata classes coimbatore', 'nata coaching rs puram', 'nata coaching peelamedu'],
    category: 'coaching',
  },
  {
    path: '/nata-coaching/madurai',
    title: 'NATA Online Coaching in Madurai',
    description: 'NATA online coaching for Madurai students with NIT/IIT alumni faculty.',
    keywords: ['nata online coaching madurai', 'nata coaching madurai online', 'nata classes madurai', 'nata coaching south tamil nadu'],
    category: 'coaching',
  },
  {
    path: '/nata-coaching/trichy',
    title: 'NATA Online Coaching in Trichy',
    description: 'NATA online coaching for Trichy students aiming at NIT Trichy.',
    keywords: ['nata online coaching trichy', 'nit trichy barch coaching', 'nata classes trichy', 'jee paper 2 coaching trichy'],
    category: 'coaching',
  },
  {
    path: '/nata-coaching/salem',
    title: 'NATA Online Coaching in Salem',
    description: 'NATA online coaching for Salem and western Tamil Nadu students.',
    keywords: ['nata online coaching salem', 'nata coaching salem online', 'nata classes salem', 'nata coaching erode', 'nata coaching namakkal'],
    category: 'coaching',
  },
  {
    path: '/nata-coaching/vellore',
    title: 'NATA Online Coaching in Vellore',
    description: 'NATA online coaching for Vellore students. VIT and Bangalore college prep.',
    keywords: ['nata online coaching vellore', 'nata coaching vellore online', 'nata classes vellore', 'vit architecture coaching'],
    category: 'coaching',
  },
  {
    path: '/nata-coaching/bangalore',
    title: 'NATA Online Coaching in Bangalore',
    description: 'NATA online coaching for Bangalore students with NIT/IIT alumni faculty.',
    keywords: ['nata online coaching bangalore', 'nata coaching bangalore online', 'nata classes bangalore', 'nata coaching koramangala', 'nata coaching hsr layout', 'nata coaching whitefield', 'nata coaching electronic city'],
    category: 'coaching',
  },
  {
    path: '/nata-coaching/hyderabad',
    title: 'NATA Online Coaching in Hyderabad',
    description: 'NATA online coaching for Hyderabad students aiming at JNAFAU, JNTU.',
    keywords: ['nata online coaching hyderabad', 'jnafau coaching', 'jntu architecture coaching', 'nata coaching madhapur', 'nata coaching gachibowli', 'nata classes hyderabad'],
    category: 'coaching',
  },
  {
    path: '/nata-coaching/mumbai',
    title: 'NATA Online Coaching in Mumbai',
    description: 'NATA online coaching for Mumbai and MMR students aiming at Sir JJ, KRVIA, Rachana Sansad.',
    keywords: ['nata online coaching mumbai', 'jj college architecture coaching', 'krvia coaching', 'nata coaching andheri', 'nata coaching powai', 'nata coaching thane', 'nata classes mumbai'],
    category: 'coaching',
  },
  {
    path: '/nata-coaching/delhi',
    title: 'NATA Online Coaching in Delhi NCR',
    description: 'NATA online coaching for Delhi NCR students aiming at SPA Delhi, USAP, Jamia Millia.',
    keywords: ['nata online coaching delhi', 'spa delhi coaching', 'nata coaching noida', 'nata coaching gurgaon', 'nata coaching ghaziabad', 'nata classes delhi ncr'],
    category: 'coaching',
  },
  {
    path: '/nata-coaching/pune',
    title: 'NATA Online Coaching in Pune',
    description: 'NATA online coaching for Pune students aiming at BNCA, Sinhgad, MIT, D Y Patil.',
    keywords: ['nata online coaching pune', 'bnca coaching', 'sinhgad architecture coaching', 'nata coaching kothrud', 'nata coaching aundh', 'nata classes pune'],
    category: 'coaching',
  },
  {
    path: '/nata-coaching/kolkata',
    title: 'NATA Online Coaching in Kolkata',
    description: 'NATA online coaching for Kolkata students aiming at Jadavpur University, IIEST.',
    keywords: ['nata online coaching kolkata', 'jadavpur university architecture', 'iiest shibpur coaching', 'nata coaching salt lake', 'nata coaching new town', 'nata classes kolkata'],
    category: 'coaching',
  },
  {
    path: '/nata-coaching/kochi',
    title: 'NATA Online Coaching in Kochi',
    description: 'NATA online coaching for Kochi and Ernakulam students aiming at CET Trivandrum, NIT Calicut.',
    keywords: ['nata online coaching kochi', 'nata online coaching ernakulam', 'nit calicut architecture coaching', 'nata coaching edappally', 'nata coaching kerala'],
    category: 'coaching',
  },
  {
    path: '/nata-coaching/ahmedabad',
    title: 'NATA Online Coaching in Ahmedabad',
    description: 'NATA online coaching for Ahmedabad students aiming at CEPT University, Nirma, SAL.',
    keywords: ['nata online coaching ahmedabad', 'cept university coaching', 'nirma architecture coaching', 'nata coaching satellite', 'nata coaching gandhinagar', 'nata classes gujarat'],
    category: 'coaching',
  },
  {
