...
const genericFaqs = [
  {
    question: 'What is the best NATA coaching available online?',
    answer: 'Neram Classes is the top-rated NATA coaching institute in India with a 99.9% success rate since 2009. With IIT/NIT alumni faculty, online and offline classes, small batches of max 25 students, and a free AI-powered study app, Neram Classes offers the most comprehensive NATA preparation.',
  },
  {
    question: 'How much does NATA coaching cost?',
    answer: 'NATA coaching fees at Neram Classes range from Rs.15,000 for a 3-month crash course to Rs.35,000 for a 2-year program. The 1-year program starts from Rs.25,000. Scholarships, EMI options, and YouTube subscription discounts are available.',
  },
  {
    question: 'Is online NATA coaching effective?',
    answer: 'Yes, our online NATA coaching maintains the same 99.9% success rate as offline classes. Live interactive sessions, daily drawing practice via screen sharing, recorded lectures for revision, and personal mentoring make online coaching equally effective.',
  },
  {
    question: 'What subjects are covered in NATA coaching?',
    answer: 'NATA coaching at Neram Classes covers all three sections: Mathematics (20% weightage), General Aptitude (40%), and Drawing (40%). We provide daily drawing practice, concept-based math teaching, and design aptitude development with 100+ mock tests.',
  },
  {
    question: 'Can I join NATA coaching after 12th?',
    answer: 'Yes, students who have completed or are appearing for 12th standard (with Mathematics as a subject) can join NATA coaching. Neram Classes offers crash courses (3 months), 1-year programs (12 months), and 2-year programs (24 months).',
  },
  {
    question: 'Is there a free demo class available?',
    answer: 'Yes, Neram Classes offers a free demo class. You can attend an online or offline demo session to experience our teaching methodology, interact with faculty, and understand the NATA exam pattern before enrolling.',
  },
];
...
export default function NataCoachingStatePage({ params: { locale, state } }: PageProps) {
  ...
  const mediumPriorityCities = stateLocations.filter((l) => l.sitemapPriority === 'medium');
  const lowPriorityCities = stateLocations.filter((l) => l.sitemapPriority === 'low');
      ...
      <Box>
        ...
        >
          ...
          <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 1 }}>
            <Box sx={{ display: 'flex', gap: 1, mb: 3, flexWrap: 'wrap' }}>
              <Chip
                label="NATA 2026"
                sx={{ bgcolor: '#FFD700', color: '#0d1b2a', fontWeight: 700, fontSize: '0.8rem' }}
              />
              <Chip
                label={stateDisplay}
          ...
          <Container maxWidth="lg">
            <Grid container spacing={2} justifyContent="center" alignItems="center">
              {[
                ...
                { label: String(cityCount), desc: `Cities in ${stateDisplay}` },
        ...
        <Box sx={{ py: { xs: 6, md: 10 } }}>
          <Container maxWidth="lg">
            ...
            >
              Neram Classes serves students across {cityCount} cities in {stateDisplay} through
              online and offline coaching. Click on any city to see detailed coaching information.
            </Typography>
        ...
        {/* =================================================================
            SECTION 4: TOP ARCHITECTURE COLLEGES
            ================================================================= */}
        {stateSeo && stateSeo.topColleges.length > 0 && (
        ...
        {/* =================================================================
            SECTION 5: ONLINE COACHING
            ================================================================= */}
        <Box sx={{ py: { xs: 6, md: 10 }, ...(stateSeo ? {} : { bgcolor: 'grey.50' }) }}>
          <Container maxWidth="lg">
            <Grid container spacing={6} alignItems="center">
              <Grid item xs={12} md={7}>
                ...
                <Typography variant="body1" paragraph sx={{ fontSize: '1.05rem', lineHeight: 1.8 }}>
                  Can&apos;t find a coaching center near you in {stateDisplay}? Neram Classes&apos;
                  online NATA coaching brings expert preparation to your home. Our live interactive
                  classes with IIT/NIT alumni faculty cover the complete NATA syllabus with daily
                  drawing practice, 100+ mock tests, and personal mentoring.
                </Typography>
                <List dense sx={{ mb: 3 }}>
                  {[
                    'Live interactive classes with screen sharing for drawing practice',
                    'Small batches of max 25 students for personal attention',
                    'Recorded lectures available for revision anytime',
                    'Free AI-powered study app with cutoff calculator and college predictor',
                    '24/7 doubt support via WhatsApp',
                    'Switch between online and offline mode anytime',
                  ].map((item, idx) => (
                ...
                >
                  Learn more about Online NATA Coaching &rarr;
                </Button>
              </Grid>
              <Grid item xs={12} md={5}>
                ...
                >
                  ...
                  <Typography variant="body2" color="text.secondary" paragraph sx={{ lineHeight: 1.7 }}>
                    Students from every city in {stateDisplay} can access the same quality coaching
                    that our Coimbatore center students receive. Our online program has the same
                    99.9% success rate as offline classes.
                  </Typography>
                  <Divider sx={{ my: 2 }} />
                  <Typography variant="body2" sx={{ fontWeight: 600 }}>
                    Available from all {cityCount} cities in {stateDisplay}
                  </Typography>
                </Paper>
              </Grid>
            </Grid>
        ...
        {/* =================================================================
            SECTION 6: COURSE PLANS
            ================================================================= */}
        <Box sx={{ py: { xs: 6, md: 10 }, bgcolor: stateSeo ? 'grey.50' : 'white' }}>
          <Container maxWidth="lg">
            <Typography
              variant="h2"
              component="h2"
              ...
              sx={{ fontWeight: 700, mb: 2 }}
            >
              NATA Coaching Courses in {stateDisplay}
            </Typography>
                        ...
                        {plan.highlights.map((h, idx) => (
                          <ListItem key={idx} sx={{ justifyContent: 'center', px: 0, py: 0.25 }}>
                            <ListItemIcon sx={{ minWidth: 24 }}>
                              <Typography color="success.main" sx={{ fontSize: '0.85rem' }}>
                                &#10003;
                              </Typography>
                            </ListItemIcon>
        ...
        {/* =================================================================
            ...
            ================================================================= */}
        <Box sx={{ py: { xs: 6, md: 10 }, bgcolor: stateSeo ? 'white' : 'grey.50' }}>
        ...
        >
          <Container maxWidth="md">
            <Typography
              ...
              component="h2"
              gutterBottom
              sx={{ fontWeight: 800, fontSize: { xs: '1.75rem', md: '2.5rem' } }}
            >
              Start Your Architecture Journey in {stateDisplay} Today
            </Typography>
            <Typography variant="h6" sx={{ mb: 4, opacity: 0.9, fontWeight: 400 }}>
              Limited seats available for NATA 2026 batches. Enroll now and join 10,000+ successful
            ...
            <Typography variant="body2" sx={{ opacity: 0.7 }}>
              Online classes available across all {cityCount} cities in {stateDisplay} | EMI and
            ...
            <Grid container spacing={2}>
              {[
                ...
                },
                {
                  ...
                  href: '/nata-2026',
                  desc: 'Exam dates, pattern, syllabus',
                },
                {
                  label: 'Free Demo Class',
                  href: '/demo-class',
                  desc: 'Try before you enroll',
                },
              ].map((link, idx) => (
