...
import { aiChatbotConfig } from '@/lib/tools/configs/ai-chatbot';

const baseUrl = 'https://neramclasses.com';
const config = aiChatbotConfig;
...
export default function AiChatbotPage({ params: { locale } }: { params: { locale: string } }) {
