...
import { josaaBarchPredictorConfig } from '@/lib/tools/configs/josaa-barch-predictor';

const baseUrl = 'https://neramclasses.com';
const config = josaaBarchPredictorConfig;
...
export async function generateMetadata({
  ...
  return {
    ...
    openGraph: {
      ...
      type: 'website',
      images: [
        { url: buildOgImage(config.ogImageTitle, config.ogImageSubtitle, 'tool') },
      ],
    },
  };
}

export default function JosaaBarchPredictorPage({
  params: { locale },
}: {
  params: { locale: string };
}) {
