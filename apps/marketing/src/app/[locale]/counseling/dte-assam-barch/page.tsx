...
import config from '@/data/counselling-2026/dte-assam-barch';
...
export default function Page({ params: { locale } }: PageProps) {
  ...
  const related = HUB_REGISTRY.filter((h) => h.slug !== config.slug && (h.region === 'east' || h.slug === 'csab-neut')).slice(0, 4);
