...
import config from '@/data/counselling-2026/dte-mp-barch';
...
export default function Page({ params: { locale } }: PageProps) {
  ...
  const related = HUB_REGISTRY.filter((h) => h.slug !== config.slug && (h.region === 'central' || h.region === 'national')).slice(0, 4);
