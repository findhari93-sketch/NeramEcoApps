...
import config from '@/data/counselling-2026/jac-chandigarh-barch';
...
export default function Page({ params: { locale } }: PageProps) {
  ...
  const related = HUB_REGISTRY.filter((h) => h.slug !== config.slug && h.examRoutes.includes('JEE_P2')).slice(0, 4);
