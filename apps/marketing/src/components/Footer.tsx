...
const footerLinks = {
  ...
  resources: [
    ...
    { label: 'NATA Entrance Exam Coaching', href: '/nata-entrance-exam-coaching' },
  ...
  topCities: [
    { label: 'Chennai', href: '/nata-coaching/chennai' },
    { label: 'Bangalore', href: '/nata-coaching/bangalore' },
    { label: 'Hyderabad', href: '/nata-coaching/hyderabad' },
    { label: 'Mumbai', href: '/nata-coaching/mumbai' },
    { label: 'Delhi NCR', href: '/nata-coaching/delhi' },
    { label: 'Pune', href: '/nata-coaching/pune' },
    { label: 'Kolkata', href: '/nata-coaching/kolkata' },
    { label: 'Kochi', href: '/nata-coaching/kochi' },
    { label: 'Ahmedabad', href: '/nata-coaching/ahmedabad' },
    { label: 'Coimbatore', href: '/nata-coaching/coimbatore' },
    { label: 'Madurai', href: '/nata-coaching/madurai' },
    { label: 'Trichy', href: '/nata-coaching/trichy' },
  ],
  topStates: [
