...
import { Box, Typography, Chip, Card, CardContent, Button } from '@neram/ui';
    ...
    >
      ...
      {imageUrl && (
        <Box sx={{ position: 'relative', width: '100%', height: 180 }}>
          <Image src={imageUrl} alt={title} fill sizes="(max-width: 600px) 100vw, 400px" style={{ objectFit: 'cover' }} />
        </Box>
      )}
