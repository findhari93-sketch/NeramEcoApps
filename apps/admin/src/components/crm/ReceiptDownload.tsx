...
import { Button, CircularProgress, IconButton, Tooltip } from '@neram/ui';
  ...
  if (iconOnly) {
    return (
      <Tooltip title="Download Receipt">
        <IconButton size="small" onClick={generateReceipt} disabled={generating}>
          {generating ? <CircularProgress size={16} /> : <DownloadIcon fontSize="small" />}
        </IconButton>
      </Tooltip>
    );
  }
