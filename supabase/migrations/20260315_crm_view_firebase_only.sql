-- Fix CRM view to exclude Nexus/admin users and add linked_classroom_email
-- Problem: Nexus students (Microsoft auth, user_type='student') leak into CRM
-- Solution: Add firebase_uid IS NOT NULL filter + include linked_classroom_email
...
-- Only Firebase-authenticated leads and students (excludes Nexus/admin Microsoft users)
